    ...
    class LateFusionDataset(cls):
        ...
        def get_item_test(self, base_data_dict, idx):
            ...
            for cav_id, selected_cav_base in base_data_dict.items():
                ...
                #             ego_lidar_pose[0]) ** 2 + (selected_cav_base['params']['lidar_pose'][1] - ego_lidar_pose[1]) ** 2)
        ...
        def get_item_single_car(self, selected_cav_base):
            ...
            # label
            # hys add for v2v4real
            if self.root_dir.split('/')[1] == 'v2vreal':
                
                lidar_pose = selected_cav_base["params"]["lidar_pose_clean"]
                ...
                # object_bbx_center, object_bbx_mask, object_ids = self.generate_object_center_single(
                #     [selected_cav_base], np.identity(4))
            else:
                object_bbx_center, object_bbx_mask, object_ids = self.generate_object_center_single(
