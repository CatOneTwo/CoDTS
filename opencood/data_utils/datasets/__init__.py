...
from opencood.data_utils.datasets.ss_intermediate_fusion_dataset import getSsintermediateFusionDataset
...
def build_dataset(dataset_cfg, visualize=False, train=True):
    ...
    assert fusion_name in ['late', 'intermediate', 'intermediate2stage', 'early', 'intermediatev2vreal', 'ssintermediate', 'intermediatedownsample']
    assert dataset_name in ['opv2v', 'v2xsim', 'dairv2x', 'v2xset', 'v2vreal']
