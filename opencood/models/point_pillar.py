...
class PointPillar(nn.Module):
    ...
    def forward(self, data_dict):
        ...
        batch_dict = self.pillar_vfe(batch_dict) # pillar_features: [80608, 64] 每个pillar的特征 (num_voxels, new_C)
        batch_dict = self.scatter(batch_dict) # spatial_features: [8, 64, 200, 504] 获得pseudo image features
