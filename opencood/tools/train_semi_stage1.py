...
# pretrain the model with labeled train set
...
def main():
    ...
    for epoch in range(init_epoch, max(epoches, init_epoch)):
        ...
        opencood_train_dataset.reinitialize() # 每个epoch需要shuffle每个场景内的车辆顺序
    ...
    if run_test:
        ...
        if 'noise_setting' in hypes and hypes['noise_setting']['add_noise']:
            ...
            cmd = f"CUDA_VISIBLE_DEVICES=6 python opencood/tools/inference.py --model_dir {saved_path} --fusion_method {fusion_method}"
