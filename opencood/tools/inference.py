...
def test_parser():
    ...
    parser.add_argument('--vis_method', default="bev", type=str, help="bev or 3D?")
...
def main():
    ...
    # hypes['validate_dir'] = hypes['root_dir'] # 测试train的预测才用
    ...
    for i, batch_data in enumerate(data_loader):
        ...
        with torch.no_grad():
            ...
            pred_box_tensor = infer_result['pred_box_tensor'] # [11, 8, 3]
            gt_box_tensor = infer_result['gt_box_tensor'] # [8, 8, 3]
            pred_score = infer_result['pred_score'] # [11]
            ...
            if (i % opt.save_vis_interval == 0) and (pred_box_tensor is not None):
                ...
                vis_save_path = os.path.join(vis_save_path_root, '%s_%05d.png' % (opt.vis_method,i))
