...
def train_parser():
    ...
    parser.add_argument('--score_thre2',  type=float,default='0.2',
                        help='score threshold')
    parser.add_argument('--back_thresh',  type=float,default='0.1',
                        help='score threshold')
...
def main():
    ...
    print('teacher_model_dir:',opt.teacher_model)
    ...
    for epoch in range(init_epoch, max(epoches, init_epoch)):
        ...
        for i, batch_data in enumerate(train_loader):
            ...
            # pseudo_targets = generate_pseudo_label_ego_eval(ego_data['label_dict_fs'],ego_data['label_dict'],teacher_ouput_dict, ego_data['anchor_box'],limit_range,score_thresh=opt.score_thre)

            pseudo_targets = generate_pseudo_label_ego(ego_data['label_dict'],teacher_ouput_dict, ego_data['anchor_box'],limit_range,score_thresh=opt.score_thre)

            pseudo_pos_equal_one = pseudo_targets['pos_equal_one']
            pseudo_neg_equal_one = pseudo_targets['neg_equal_one']
            pseudo_target = pseudo_targets['targets']
