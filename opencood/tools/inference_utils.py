...
def inference_intermediate_fusion_for_pseudo_label(batch_data, model, dataset, score_threshold=0.2):
    """
    Model inference for intermediate fusion for pseudo label.
    ...
    pred_box_tensor, pred_score, gt_box_tensor, mask_index = \
        dataset.post_process_for_pseudo_label(batch_data,
                             output_dict)
